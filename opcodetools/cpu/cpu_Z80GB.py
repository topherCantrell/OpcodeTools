...
OPCODES = [
    ...
    {"mnemonic": "LD (t),SP",        "code": "08t0t1",           "use": "t=data_w",    "difZ80":"Z80 is EX AF,AF'"}, 
    ...
    {"mnemonic": "STOP",             "code": "1000",             "use": "",            "difZ80":"Z80 is DNJZ"},    
    ...
    {"mnemonic": "LD A,(HL+)",       "code": "2A",               "use": "",            "difZ80":"Z80 is LD HL,(t)"},
    ...
    {"mnemonic": "LD (HL-),A",       "code": "32",               "use": "",            "difZ80":"Z80 is LD (t),A" },
    ...
    {"mnemonic": "LD A,(HL-)",       "code": "3A",               "use": "",            "difZ80":"Z80 is LD A,(t)" },
    ...
    {"mnemonic": "SBC A,B",          "code": "98",               "use": ""             },
    {"mnemonic": "SBC A,C",          "code": "99",               "use": ""             },
    {"mnemonic": "SBC A,D",          "code": "9A",               "use": ""             },
    {"mnemonic": "SBC A,E",          "code": "9B",               "use": ""             },
    {"mnemonic": "SBC A,H",          "code": "9C",               "use": ""             },
    {"mnemonic": "SBC A,L",          "code": "9D",               "use": ""             },
    {"mnemonic": "SBC A,(HL)",       "code": "9E",               "use": ""             },
    {"mnemonic": "SBC A,A",          "code": "9F",               "use": ""             },    
    ...
    {"mnemonic": "ADD A,b",          "code": "C6bb",             "use": "b=const"      }, 
    {"mnemonic": "RST 00",           "code": "C7",               "use": ""             },
    ...
    {"mnemonic": "ADC A,b",          "code": "CEbb",             "use": "b=const"      },    
    {"mnemonic": "RST 08",           "code": "CF",               "use": ""             },   
    {"mnemonic": "RET NC",           "code": "D0",               "use": ""             },
    {"mnemonic": "POP DE",           "code": "D1",               "use": ""             },
    {"mnemonic": "JP NC,t",          "code": "D2t0t1",           "use": "t=code"       },
    # UNUSED D3 difZ80 is out (b),A
    {"mnemonic": "CALL NC,t",        "code": "D4t0t1",           "use": "t=code"       },
    {"mnemonic": "PUSH DE",          "code": "D5",               "use": ""             },
    {"mnemonic": "SUB b",            "code": "D6bb",             "use": "b=const"      },
    {"mnemonic": "RST 10",           "code": "D7",               "use": ""             },
    {"mnemonic": "RET C",            "code": "D8",               "use": ""             },
    {"mnemonic": "RETI",             "code": "D9",               "use": "",            "difZ80":"Z80 is EXX" },
    {"mnemonic": "JP C,t",           "code": "DAt0t1",           "use": "t=code"       },    
    # UNUSED DB difZ80 is in A,(b)
    {"mnemonic": "CALL C,t",         "code": "DCt0t1",           "use": "t=code"       },    
    # UNUSED DD difZ80 this is a prefix to the IX instructions not in GB
    {"mnemonic": "SBC A,b",          "code": "DEbb",             "use": "b=const"      },   
    {"mnemonic": "RST 18",           "code": "DF",               "use": ""             },    
    {"mnemonic": "LD ($FF00+b),A",   "code": "E0bb",             "use": "b=const",     "difZ80":"Z80 RET PO"      },
    {"mnemonic": "POP HL",           "code": "E1",               "use": ""             },
    {"mnemonic": "LD ($FF00+C),A",   "code": "E2",               "use": "",            "difZ80":"Z80 is JP PO,t" },
    # UNUSED E3 difZ80 is EX (SP),H
    # UNUSED E4 difZ80 is CALL PO,t
    {"mnemonic": "PUSH HL",          "code": "E5",               "use": ""             },
    {"mnemonic": "AND b",            "code": "E6bb",             "use": "b=const"      }, 
    {"mnemonic": "RST 20",           "code": "E7",               "use": ""             },
    {"mnemonic": "ADD SP,b",         "code": "E8bb",             "use": "b=const",     "difZ80":"Z80 is RET PE"},
    {"mnemonic": "JP (HL)",          "code": "E9",               "use": ""             },    
    {"mnemonic": "LD (t),A",         "code": "EAt0t1",           "use": "t=data_w",    "difZ80":"Z80 is JP PE,t" },
    # UNUSED EB difZ80 is EX, DE,HL
    # UNUSED EC difZ80 is CALL PE, t
    # UNUSED ED difZ80 is a prefix to the EXTD instructions not in GB
    {"mnemonic": "XOR b",            "code": "EEbb",             "use": "b=const"      },
    {"mnemonic": "RST 28",           "code": "EF",               "use": ""             },   
    {"mnemonic": "LD A,($FF00+b)",   "code": "F0bb",             "use": "b=const",     "difZ80":"Z80 is RET P" },
    {"mnemonic": "POP AF",           "code": "F1",               "use": ""             },
    {"mnemonic": "LD A,($FF00+C)",   "code": "F2",               "use": "",            "difZ80":"Z80 is JP P,t" },
    {"mnemonic": "DI",               "code": "F3",               "use": ""             },
    # UNUSED F4  difZ80 is CALL P,t
    {"mnemonic": "PUSH AF",          "code": "F5",               "use": ""             },    
    {"mnemonic": "OR b",             "code": "F6bb",             "use": "b=const"      },   
    {"mnemonic": "RST 30",           "code": "F7",               "use": ""             },
    {"mnemonic": "LD HL,SP+s",       "code": "F8ss",             "use": "s=sconst",    "difZ80":"Z80 is RET M" },
    {"mnemonic": "LD SP,HL",         "code": "F9",               "use": ""             },
    {"mnemonic": "LD A,(t)",         "code": "FAt0t1",           "use": "t=data_r",    "difZ80":"Z80 is JP M,t" },    
    {"mnemonic": "EI",               "code": "FB",               "use": ""             },
    # UNUSED FC difZ80 is CALL M,t
    # UNUSED FD difZ80 is a prefix to the IY instructions not in GB
    {"mnemonic": "CP b",             "code": "FEbb",             "use": "b=const"      },
    {"mnemonic": "RST 38",           "code": "FF",               "use": ""             }, 
    ...
    {"mnemonic": "SWAP B",           "code": "CB30",             "use": "",            "difZ80":"Z80 is SLL B"},
    {"mnemonic": "SWAP C",           "code": "CB31",             "use": "",            "difZ80":"Z80 is SLL C"},
    {"mnemonic": "SWAP D",           "code": "CB31",             "use": "",            "difZ80":"Z80 is SLL D"},
    {"mnemonic": "SWAP E",           "code": "CB31",             "use": "",            "difZ80":"Z80 is SLL E"},
    {"mnemonic": "SWAP H",           "code": "CB31",             "use": "",            "difZ80":"Z80 is SLL H"},
    {"mnemonic": "SWAP L",           "code": "CB31",             "use": "",            "difZ80":"Z80 is SLL L"},
    {"mnemonic": "SWAP (HL)",        "code": "CB36",             "use": "",            "difZ80":"Z80 is SLL (HL)"},
    {"mnemonic": "SWAP A",           "code": "CB37",             "use": "",            "difZ80":"Z80 is SLL A"},
